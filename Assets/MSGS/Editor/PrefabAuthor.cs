...
namespace MiniScript.MSGS.Editor
{
    ...
    public class PrefabAuthor : MonoBehaviour
    {
        [MenuItem("GameObject/MSGS/Prefab/Create Prefab", false, 0)]
        ...
        static SpriteSheet _spriteatlas;

        static List<GameObject> listOfChildren;
        static List<Component> listOfComponents;
        static DataSet _set;
        ...
        static bool AppendComponents(GameObject go)
        {
            List<Component> tmp = new List<Component>();
