    ...
    public static class MaxQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the Max query.");
                ...
                {
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.Max,
            ...
            map.map.Add(new ValString("Max"), a.GetFunc());
            #endregion
        }
    }
}