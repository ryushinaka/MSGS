...
{
    public static class WhereNotQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the WhereNot query.");
                ...
                {   //enqueue the query command/parameter
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.WhereNot,
            ...
            map.map.Add(new ValString("WhereNot"), a.GetFunc());
            #endregion
        }
    }
}
