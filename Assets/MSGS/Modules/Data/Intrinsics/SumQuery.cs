    ...
    public static class SumQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the Sum query.");
                ...
                {
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.Sum,
            ...
            map.map.Add(new ValString("Sum"), a.GetFunc());
            #endregion
        }
    }
}