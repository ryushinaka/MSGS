    ...
    public static class OrderByQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the OrderBy query.");
                ...
                {
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.OrderBy,
            ...
            map.map.Add(new ValString("OrderBy"), a.GetFunc());
            #endregion
        }
    }
}