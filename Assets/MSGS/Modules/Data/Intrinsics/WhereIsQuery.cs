...
{
    public static class WhereIsQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the WhereIs query.");
                ...
                {
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.WhereIs,
            ...
            map.map.Add(new ValString("WhereIs"), a.GetFunc());
            #endregion
        }
    }
}
