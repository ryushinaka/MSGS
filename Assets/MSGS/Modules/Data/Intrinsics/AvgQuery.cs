    ...
    public static class AvgQuery
    {
        public static void Query(ref ValMap map)
        {
            ...
            a.code = (context, partialResult) =>
            {
                ...
                {
                    context.interpreter.standardOutput("The property name ('" + context.GetLocalString("propname") + "') could not be found for the Avg query.");
                ...
                {
                    DatabaseModule.EnqueueQuery(chd.dbID, QueryCommandType.Avg,
            ...
            map.map.Add(new ValString("Avg"), a.GetFunc());
            #endregion
        }
    }
}