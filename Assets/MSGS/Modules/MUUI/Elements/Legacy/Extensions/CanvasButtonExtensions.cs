...
{
    public static class CanvasButtonExtensions
    {
        public static ValMap ToValMap(this CanvasButton button)
        {
        ...
        public static bool UpdateButton(this CanvasButton button, Value a, Value b)
        {
            if (a is ValString)
            {
                ...
                switch (s)
                {
                    case "name":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").name property with a non-String(ValString) parameter." +
                    ...
                    case "enabled":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").enabled property with a non-boolean(ValNumber) parameter." +
                    ...
                    case "OnPointerEnterHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerEnterHandler property failed because the specified script(" +
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerEnterHandler property with a non-String parameter." +
                    ...
                    case "OnPointerExitHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerExitHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerExitHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerLeftClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerDoubleLeftClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerDoubleClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerDoubleClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    ...
                    case "OnPointerRightClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerRightClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerRightClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerMiddleClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to CanvasButton(" + button.gameObject.name + ").OnPointerMiddleClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for CanvasButton(" + button.gameObject.name + ").OnPointerMiddleClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    ...
                    //        //else
                    //        //{
                    //        //    MiniScriptSingleton.LogWarning("Sprite Asset Path given for CanvasButton(" + button.gameObject.name + ").Sprite was not found." +
                    ...
                    //    else
                    //    {
                    //        MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ").Sprite with a property value that is not a String. " +
                    ...
                    case "ColorR":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ").Image.color.R with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorG":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ").Image.color.G with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorB":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ").Image.color.B with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorA":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ").Image.color.A with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "Text":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ").Text property with an argument that is neither a String nor a Number, no change made. " +
                    ...
                    case "Bold":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify CanvasButton.Text(" + button.gameObject.name + ").FontStyle.Bold property with an argument that is neither a String nor a Number, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "Italic":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ").FontStyle.Italic property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "Underline":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ").FontStyle.Underline property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "Strike":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ").FontStyle.Strike property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "Lowercase":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.Lowercase property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "Uppercase":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.Uppercase property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "SmallCaps":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.SmallCaps property with an argument that is not boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "alignVertical":
                        ...
                        if (b is ValString)
                        {
                            switch (b.ToString())
                            {
                                ...
                                default:
                                    MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ".alignVertical with an unsupported argument." +
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ".alignVertical with an unsupported argument.  Argument should be a String containing" +
                    ...
                    case "alignHorizontal":
                        ...
                        if (b is ValString)
                        {
                            switch (b.ToString())
                            {
                                ...
                                default:
                                    MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ".alignHorizontal with an unsupported argument." +
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Text(" + button.gameObject.name + ".alignHorizontal with an unsupported argument.  Argument should be a String containing" +
                    ...
                    case "FontSize":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontSize property with an argument that is not a Number, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "FontSizeMin":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.FontSizeMin property with an argument that is not a Number, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "FontSizeMax":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.FontSizeMax property with an argument that is not a Number, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    case "AutoSize":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_text(" + button.gameObject.name + ").FontStyle.AutoSize property with an argument that is not a boolean, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
                    default:
                        if (b is null) { MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ") with an unknown property label (" + s + ")."); }
                        else { MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ") with an unknown property label (" + s + ") with an argument that appears to be of type " + b.GetType().ToString()); }
                        return false;
                }
            }
            else
            {
                if (a == null)
                {
                    MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ") with a property label accessor that is null.");
                }
                else if (a != null)
                {
                    MiniScriptSingleton.LogError("Attempt to modify CanvasButton(" + button.gameObject.name + ") with a property label accessor that is not a String. It appears to be a (" + a.GetType().Name + ").");
                }
        ...
        public static void SetupButton(this CanvasButton button, ref DataRow row)
        {
            ...
            button.ScriptOnLeftClick = (string)row["OnPointerLeftClickHandler"].ToString();
            button.ScriptOnDoubleLeftClick = (string)row["OnPointerDoubleLeftClickHandler"].ToString();
            button.ScriptOnRightClick = (string)row["OnPointerRightClickHandler"].ToString();
            button.ScriptOnDoubleRightClick = (string)row["OnPointerDoubleRightClickHandler"].ToString();
            button.ScriptOnMiddleClick = (string)row["OnPointerMiddleClickHandler"].ToString();
            ...
            if (row["TextValue"].ToString().Length > 0)
            {
                button.Text.SetText((string)row["TextValue"]);
                button.Text.color = new Color(
