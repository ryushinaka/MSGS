    ...
    public static class ButtonExtensions
    {
        ...
        public static bool UpdateButton(this TwoDimensional.MUUIButton button, Value a, Value b)
        {
            if (a is ValString)
            {
                ...
                switch (s)
                {
                    case "name":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").name property with a non-String(ValString) parameter." +
                    ...
                    case "enabled":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").enabled property with a non-boolean(ValNumber) parameter." +
                    ...
                    case "OnPointerEnterHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerEnterHandler property failed because the specified script(" +
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerEnterHandler property with a non-String parameter." +
                    ...
                    case "OnPointerExitHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerExitHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerExitHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerLeftClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerDoubleLeftClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerDoubleClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerDoubleClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    ...
                    case "OnPointerRightClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerRightClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerRightClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    case "OnPointerMiddleClickHandler":
                        ...
                        if (b is ValString)
                        {
                            ...
                            {   //script does not exist within the mod data
                                MiniScriptSingleton.LogWarning("Assigning a new script to MUUI_Button(" + button.gameObject.name + ").OnPointerMiddleClickHandler property failed because the specified script(" +
                                    ((ValString)b).value + " could not be found.");
                                return false;
                            }
                        }
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify mouse event handler script for MUUI_Button(" + button.gameObject.name + ").OnPointerMiddleClickHandler property with a non-String parameter." +
                                " The expected argument should be a string containing the script name. The argument given appears to be of " + b.GetType().Name + " type.");
                            return false;
                        }
                    #endregion
                    ...
                    //        //else
                    //        //{
                    //        //    MiniScriptSingleton.LogWarning("Sprite Asset Path given for MUUI_Button(" + button.gameObject.name + ").Sprite was not found." +
                    ...
                    //    else
                    //    {
                    //        MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ").Sprite with a property value that is not a String. " +
                    ...
                    case "ColorR":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ").Image.color.R with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorG":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ").Image.color.G with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorB":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ").Image.color.B with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    case "ColorA":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ").Image.color.A with a property value that is not a Number. " +
                                " Argument given appears to be of type " + b.GetType().Name);
                            return false;
                        }
                    #endregion
                    ...
                    case "Bold":
                        ...
                        {
                            MiniScriptSingleton.LogError("Attempt to modify MUUI_button.Text(" + button.gameObject.name + ").FontStyle.Bold property with an argument that is neither a String nor a Number, no change made. " +
                                 " Argument appears to be of type " + b.GetType().ToString());
                            return false;
                        }
                    #endregion
            ...
            else
            {
                if (a == null)
                {
                    MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ") with a property label accessor that is null.");
                }
                else if (a != null)
                {
                    MiniScriptSingleton.LogError("Attempt to modify MUUI_Button(" + button.gameObject.name + ") with a property label accessor that is not a String. It appears to be a (" + a.GetType().Name + ").");
                }
