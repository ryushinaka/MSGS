...
namespace MiniScript.MSGS.MUUI.TwoDimensional
{
    ...
    public class InputField : MonoBehaviour, UI_Element, IControl, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        float mscroll;
        bool benter;
        ...
        private static void EditorAddInputField()
        {
            ...
            if (go == null) { return; }
            go.AddComponent<MiniScript.MSGS.MUUI.TwoDimensional.InputField>();
            ...
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.InputField>().Inputfield = go.GetComponent<TMPro.TMP_InputField>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.InputField>().Placeholder =
                placeholder.GetComponent<TextMeshProUGUI>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.InputField>().Text =
                text.GetComponent<TextMeshProUGUI>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.InputField>().Mask =
