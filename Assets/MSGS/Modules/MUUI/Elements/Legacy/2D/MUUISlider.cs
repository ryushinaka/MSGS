...
namespace MiniScript.MSGS.MUUI.TwoDimensional
{
    ...
    public class MUUISlider : MonoBehaviour, UI_Element, IControl, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        float mscroll;
        bool benter;
        ...
        public bool wholeNumbers, interactable;
        ...
        void Start()
        {
            ...
            eventFilter = new ControlCollectionEventFilter()
            {
                events = new List<int>()
                {
                    SliderMouseEnter,
                    SliderMouseExit,
                    SliderMouseLeftClick,
                    SliderMouseRightClick,
                    SliderMouseMiddleClick,
                    SliderMouseDoubleLeftClick,
                    SliderMouseDoubleRightClick,
                    SliderMouseScrollUp,
                    SliderMouseScrollDown,
                }
            };
        }
        ...
        public virtual void OnPointerEnter(PointerEventData eventData)
        {
            ...
            tmp.ElementType = UIElementType.Slider;
            //MiniScriptSingleton.EventSink.HandleEvent(this, ref tmp);
            eventContainer.ScriptOnEnter(tmp, eventData);
        }
        ...
        public virtual void OnPointerExit(PointerEventData eventData)
        {
            ...
            tmp.ElementType = UIElementType.Slider;
            //MiniScriptSingleton.EventSink.HandleEvent(this, ref tmp);
            eventContainer.ScriptOnExit(tmp, eventData);
        }
