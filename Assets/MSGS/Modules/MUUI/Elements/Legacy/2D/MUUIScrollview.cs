...
{    
    public class MUUIScrollview : MonoBehaviour, UI_Element, IControl, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        float mscroll;
        bool benter;
        ...
        private static void AddScrollview()
        {
            ...
            if (go == null) { return; }
            go.AddComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>();
            ...
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().Rect = go.GetComponent<RectTransform>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().ScrollRect = go.GetComponent<ScrollRect>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().ScrollBackground = go.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().HorizontalBar = horiz.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().VerticalBar = verti.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().HorizontalHandle = hhandle.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().VerticalHandle = vhandle.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().ContentObject = content;
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().Viewport = viewport;
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().Horizontal = horiz.GetComponent<Scrollbar>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().Vertical = verti.GetComponent<Scrollbar>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().layoutgroup = content.GetComponent<VerticalLayoutGroup>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.MUUIScrollview>().fitter = content.GetComponent<ContentSizeFitter>();
        }
