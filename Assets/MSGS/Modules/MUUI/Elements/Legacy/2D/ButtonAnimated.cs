...
namespace MiniScript.MSGS.MUUI.TwoDimensional
{
    ...
    public class ButtonAnimated : MonoBehaviour, UI_Element, IControl, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        float mscroll;
        bool benter;
        ...
        private static void AddConfig()
        {
            ...
            if (go == null) { return; }
            go.AddComponent<MiniScript.MSGS.MUUI.TwoDimensional.ButtonAnimated>();
            //make sure the references are put in place
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.ButtonAnimated>().image = go.GetComponent<UnityEngine.UI.Image>();
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.ButtonAnimated>().Rect = go.GetComponent<UnityEngine.RectTransform>();
            var child = new GameObject("Text (TMP)");
            child.transform.SetParent(go.transform);
            child.AddComponent<TextMeshProUGUI>();
            child.transform.localPosition = new Vector3(0, 0, 0);
            child.transform.localScale = new Vector3(1, 1, 1);
            go.GetComponent<MiniScript.MSGS.MUUI.TwoDimensional.ButtonAnimated>().Text = child.GetComponent<TextMeshProUGUI>();
        }
