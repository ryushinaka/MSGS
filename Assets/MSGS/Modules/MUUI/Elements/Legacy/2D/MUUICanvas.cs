...
{
    [RequireComponent(typeof(MUUICanvas))]
    public class MUUICanvas : MonoBehaviour, IControl, UI_Element
    {
        ...
        void Start()
        {
            if (self == null)
            {
                ...
                canvas = self.AddComponent<MUUICanvas>();
            ...
            canvas = GetComponent<MUUICanvas>();
